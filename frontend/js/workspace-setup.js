...
const WorkspaceSetup = (() => {
  ...
  async function initPresets() {
    ...
    const valMap = {
      ...
      sample_every:"full-sample-every",
      sample_duration:"full-sample-duration", sample_steps:"full-sample-steps",
      sample_seed:"full-sample-seed", sample_lyrics:"full-sample-lyrics",
      loss_milestone_interval:"full-loss-milestone-interval",
      timestep_window_min:"full-timestep-window-min", timestep_window_max:"full-timestep-window-max",
