...
const WorkspaceConfig = (() => {
  ...
  function gatherFullConfig() {
    ...
    const cfg = {
      ...
      dynamic_channel_balance: _c("full-dynamic-channel-balance") || false,
      timestep_window_min: _v("full-timestep-window-min", "0"),
      timestep_window_max: _v("full-timestep-window-max", "1"),
      ...
      save_every: _v("full-save-every", "50"), sample_every: _v("full-sample-every", "0"),
      sample_duration: _v("full-sample-duration", "30"), sample_steps: _v("full-sample-steps", "0"),
      sample_seed: _v("full-sample-seed", "42"), sample_lyrics: _v("full-sample-lyrics", ""),
      log_every: _v("full-log-every", "10"),
      ...
      loss_milestone_interval: _v("full-loss-milestone-interval", "0"),
