...
def build_train_namespace(a: dict, mode: str = "train") -> argparse.Namespace:
    ...
    return argparse.Namespace(
        ...
        loss_milestone_interval=a.get("loss_milestone_interval", DEFAULT_LOSS_MILESTONE_INTERVAL),
        ...
        timestep_window_min=a.get("timestep_window_min", 0.0),
        timestep_window_max=a.get("timestep_window_max", 1.0),
        sample_every=a.get("sample_every", DEFAULT_SAMPLE_EVERY),
        sample_duration=a.get("sample_duration", DEFAULT_SAMPLE_DURATION),
        sample_steps=a.get("sample_steps", DEFAULT_SAMPLE_STEPS),
        sample_seed=a.get("sample_seed", DEFAULT_SAMPLE_SEED),
        sample_lyrics=a.get("sample_lyrics", ""),
        sample_backend=a.get("sample_backend", "auto"),
    )
