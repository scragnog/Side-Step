...
def build_training_config(
    ...
    train_cfg = TrainingConfigV2(
        ...
        sample_every_n_epochs=_get(p, "sample_every", DEFAULT_SAMPLE_EVERY),
        sample_duration=_get(p, "sample_duration", DEFAULT_SAMPLE_DURATION),
        sample_steps=_get(p, "sample_steps", DEFAULT_SAMPLE_STEPS),
        sample_seed=_get(p, "sample_seed", DEFAULT_SAMPLE_SEED),
        sample_lyrics=_get(p, "sample_lyrics", ""),
        sample_backend=_get(p, "sample_backend", DEFAULT_SAMPLE_BACKEND),
        ...
        target_loss_auto_stop=_get(p, "target_loss_auto_stop", DEFAULT_TARGET_LOSS_AUTO_STOP),
        ...
        loss_milestone_interval=_get(p, "loss_milestone_interval", DEFAULT_LOSS_MILESTONE_INTERVAL),
        ...
        timestep_window_min=_get(p, "timestep_window_min", 0.0),
        timestep_window_max=_get(p, "timestep_window_max", 1.0),
